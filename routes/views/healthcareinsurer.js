...
var Healthcareinsurer = keystone.list('Healthcareinsurer');
...
exports = module.exports = function(req, res) {
	...
	// Init locals
		locals.section = 'healthcareinsurer';
		locals.data = [];

	// Load the current Healthcareinsurer
	view.on('init', function(next) {
		var q = Healthcareinsurer.model.find();
		q.exec(function(err, results) {
			locals.data.healthcareinsurers = results;
			next(err);
		});
	});
