...
exports = module.exports = function(app) {
	...
	app.get('/companyprofile', routes.views.companyprofile);
	app.get('/navbar', routes.views.navbar);
	app.get('/menu',routes.views.menu);
	app.get('/footer',routes.views.footer);
	app.get('/offering', routes.views.offering);
	app.get('/mangementteam', routes.views.mangementteam);
	app.get('/differentiator', routes.views.differentiator);
	app.get('/career', routes.views.career);
	app.get('/contactlist', routes.views.contactlist);
